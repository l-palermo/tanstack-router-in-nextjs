...
export const BaseRoute = (basePath: string, RootRoute: RootRoute) => createRoute({
  path: basePath,
...
export const FeatureContextRoute = (basePath: string, RootRoute: RootRoute) => {
  ...
  return featureContextRoute.addChildren([screenOneRoute(featureContextRoute), screenTwoRoute(featureContextRoute)])
};